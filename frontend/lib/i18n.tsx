...
const STRINGS: Record<Lang, Dict> = {
  uz: {
    ...
    'home.stat.products': 'Mahsulot turi',
    'home.stat.categories': 'Kategoriya',
    'home.stat.years': 'Yil bozorda',
    'home.stat.tons': 'Sotilgan mahsulot',
    'home.stat.employees': 'Xodimlar',
    'home.stat.dealers': 'Dilerlik markazlari',
    'stats.title': 'Chilon raqamlarda',
    'stats.subtitle': 'Ishonchimiz asosi',
    'stats.additives': 'Xalqaro qo\'shimchalar bazasi',
  ...
  en: {
    ...
    'home.stat.products': 'Product types',
    'home.stat.categories': 'Categories',
    'home.stat.years': 'Years on the market',
    'home.stat.tons': 'Product sold',
    'home.stat.employees': 'Employees',
    'home.stat.dealers': 'Dealer centres',
    'stats.title': 'Chilon in numbers',
    'stats.subtitle': 'What we are built on',
    'stats.additives': 'International additive base',
  ...
  ru: {
    ...
    'home.stat.products': 'Видов продукции',
    'home.stat.categories': 'Категорий',
    'home.stat.years': 'Лет на рынке',
    'home.stat.tons': 'Продано продукции',
    'home.stat.employees': 'Сотрудников',
    'home.stat.dealers': 'Дилерских центров',
    'stats.title': 'Chilon в цифрах',
    'stats.subtitle': 'Основа нашей надёжности',
    'stats.additives': 'Международная база присадок',
